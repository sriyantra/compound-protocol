...
contract IERC4626 is EIP20Interface {
    ...
    */
    function withdraw(address from, address to, uint256 underlyingAmount) public returns (uint256 shares);
    ...
    */
    function redeem(address from, address to, uint256 shareAmount) public returns (uint256 value);
